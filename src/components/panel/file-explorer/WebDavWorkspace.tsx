...
/** Main-area dual-pane WebDAV: local left, remote right. No SSH session. */
      ...
      <div ref={containerRef} className="flex min-h-0 min-w-0 flex-1 flex-row">
        ...
        >
          <FileExplorerPane
            ...
            activeSessionType="WebDAV"
            activeConnectionId={null}
            activeSessionName={pane.name}
            forceBackend="local"
            headerMeta={t("webdavWorkspace.local")}
        ...
        >
          <FileExplorerPane
            ...
            activeSessionName={pane.name}
            forceBackend="webdav"
            headerMeta={t("webdavWorkspace.remote")}
            showTerminalActions={false}
