...
function preserveAppSettingsReferences(prev: AppSettings, next: AppSettings): AppSettings {
  ...
  const cloudSync = areSettingsValuesEqual(prev.cloud_sync, next.cloud_sync)
    ? prev.cloud_sync
    : next.cloud_sync;
  const rdp = areSettingsValuesEqual(prev.rdp, next.rdp) ? prev.rdp : next.rdp;
...
const WORKSPACE_UI_KEYS = [
  ...
  "start_workspace_mode",
  "network_panel_active_tab",
  "security_auth_panel_active_tab",
  "quick_cmd_view_mode",
  "quick_cmd_sort_mode",
  "quick_cmd_selected_category",
  "saved_connections_expanded_group_ids",
  "saved_connections_last_opened_connection_id",
  "saved_connections_sort_mode",
  "asset_sort_key",
  ...
  "show_ascend_npu_monitor",
  "ascend_npu_monitor_interval",
  "show_process_manager",
  "process_manager_interval",
  "show_docker_manager",
  "docker_manager_interval",
...
function preserveWorkspaceUiOnReload(current: UiConfig, incoming: UiConfig): UiConfig {
  return {
    ...
    show_note_outline: current.show_note_outline,
    note_outline_width: current.note_outline_width,
    notes_expanded_folder_ids: current.notes_expanded_folder_ids,
    notes_last_selected_node_id: current.notes_last_selected_node_id,
    start_workspace_mode: current.start_workspace_mode,
    network_panel_active_tab: current.network_panel_active_tab,
    security_auth_panel_active_tab: current.security_auth_panel_active_tab,
    quick_cmd_view_mode: current.quick_cmd_view_mode,
    quick_cmd_sort_mode: current.quick_cmd_sort_mode,
    quick_cmd_selected_category: current.quick_cmd_selected_category,
    saved_connections_expanded_group_ids: current.saved_connections_expanded_group_ids,
    saved_connections_last_opened_connection_id:
      current.saved_connections_last_opened_connection_id,
    saved_connections_sort_mode: current.saved_connections_sort_mode,
    asset_sort_key: current.asset_sort_key,
    asset_sort_direction: current.asset_sort_direction,
    recent_connection_ids: current.recent_connection_ids,
    file_explorer_auto_sync_cwd_connection_ids:
      current.file_explorer_auto_sync_cwd_connection_ids,
    file_explorer_favorite_dirs_by_connection_id:
      current.file_explorer_favorite_dirs_by_connection_id,
    file_explorer_show_hidden_files: current.file_explorer_show_hidden_files,
    panel_open_mode: current.panel_open_mode,
    header_status_mode: current.header_status_mode,
    header_status_visible: current.header_status_visible,
    serial_send_clear_after_send: current.serial_send_clear_after_send,
    ...
    gpu_monitor_interval: current.gpu_monitor_interval,
    show_ascend_npu_monitor: current.show_ascend_npu_monitor,
    ascend_npu_monitor_interval: current.ascend_npu_monitor_interval,
    show_process_manager: current.show_process_manager,
    process_manager_interval: current.process_manager_interval,
    show_docker_manager: current.show_docker_manager,
    docker_manager_interval: current.docker_manager_interval,
    terminal_window_layout: current.terminal_window_layout,
