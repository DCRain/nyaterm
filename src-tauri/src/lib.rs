...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            cmd::note::encrypt_note,
            cmd::note::decrypt_note,
            cmd::note::change_note_password,
            cmd::note::encrypt_note_folder,
            cmd::note::decrypt_note_folder,
            cmd::note::change_folder_password,
            ...
            cmd::ftp::get_ftp_file_properties,
            ...
            cmd::webdav::get_webdav_file_properties,
            ...
            cmd::local_fs::read_user_text_file,
            cmd::local_fs::write_user_text_file,
            cmd::local_fs::write_user_binary_file,
            cmd::remote_desktop::list_remote_desktop_clients,
            ...
            cmd::connection::restore_builtin_quick_commands,
