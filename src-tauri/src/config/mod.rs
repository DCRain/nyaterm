...
pub use settings::{
    ...
    ExternalMcpSessionScope, ExternalMcpSettings, OpenCodeIntegrationSettings, GeneralSettings,
    ...
    ThemeColorsConfig, ThemeConfig, NoteColorsConfig, TransferSettings, TranslationSettings,
