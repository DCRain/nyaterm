...
pub use connection::{
    ...
    SshProfile, SshTerminalType, TelnetAutoLoginConfig, VncClipboardSettings, VncDisplaySettings,
    VncReconnectSettings, VncSecuritySettings, connection_custom_icon_from_data_url,
    connection_custom_icon_id_for_data_url, effective_cwd_follow_mode,
    effective_cwd_follow_mode_for_profile, is_connection_custom_icon_data_url, load_config,
