...
mod tests {
    use super::{
        ...
        is_totp_code_reused, load_default_openssh_identity_from_dir, record_totp_code_use,
        resolve_password_material, resolve_ssh_target, seconds_until_next_totp_step,
        should_auto_fill_otp_prompts, should_auto_fill_password_prompts, used_totp_codes,
    };
